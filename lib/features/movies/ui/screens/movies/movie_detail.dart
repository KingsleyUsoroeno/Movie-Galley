              ...
              child: Stack(
                ...
                children: <Widget>[
                  Container(
                    ...
                    height: 250.0,
                    decoration:
                        BoxDecoration(image: DecorationImage(image: NetworkImage(imageUrl + movieResult.posterPath), fit: BoxFit.cover)),
                    child: Container(
                      height: 350.0,
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: <Widget>[
                              Text(movieResult.title, style: boldTextStyle.copyWith(fontSize: 22.0)),
                              Text(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 10.0),
                  Text(movieResult.overview, style: TextStyle(fontWeight: FontWeight.w400, fontSize: 16.0)),
                ],
              ),
            )
          ],
