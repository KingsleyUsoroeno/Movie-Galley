...
import 'features/movies/data/service/movie_api_service.dart';
...
Future<void> init() async {
  ...
  injector.registerLazySingleton<MovieRepository>(
    () => MovieRepositoryImpl(remoteDataSource: injector.get(), localDataSource: injector.get(), networkInfo: injector.get()),
  );
  ...
  injector.registerLazySingleton<MovieApiService>(
    () => MovieApiServiceImpl(client: injector.get()),
  );
