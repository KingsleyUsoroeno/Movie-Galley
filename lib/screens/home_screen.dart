...
class HomeScreen extends StatelessWidget {
    ...
    return BlocBuilder<NowPlayingMoviesBloc, NowPlayingMoviesState>(
      builder: (context, NowPlayingMoviesState state) {
        if (state is NowPlayingMovieLoading) {
          ...
          final popularMovies = state.movie;
          return Column(
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                      ...
                      onTap: () => _navigateToNowPlayingDetailScreen(popularMovies.results)),
                ],
              ),
              SizedBox(height: 8.0),
              Container(
  ...
  void _navigateToNowPlayingDetailScreen(List<Results> movies) {
